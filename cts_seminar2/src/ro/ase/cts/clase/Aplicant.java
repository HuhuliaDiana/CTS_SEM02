...
public abstract class Aplicant {
	...
	public void afisareStatutPeProiect(Proiect proiect) {
		...
		sb.append(proiect.getPragAcceptare() < punctaj ? " a fost acceptat." : " nu a fost acceptat.");
	...
	public int getNrPoiecte() {
		return nrProiecte;
	}

	public void setDenumiriProiecte(int nrProiecte, String[] vect) {
		this.nrProiecte = nrProiecte;
